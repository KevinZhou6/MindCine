...
checkpoint_callback = ModelCheckpoint(
    dirpath=f'../checkpoints/BENDR/{current_time}/',  # 模型保存的文件夹
    filename='best_model_40_classes-sub12',  # 文件名
...
trainer = pl.Trainer(accelerator='cuda',
                        ...
                        callbacks=callbacks,
                        logger=[ 
                                pl_loggers.CSVLogger('../logs/', name="BENDR_csv",version=f'{current_time}')],
