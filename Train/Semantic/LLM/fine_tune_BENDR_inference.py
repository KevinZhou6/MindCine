...
import os 
import tqdm
from Modules.BENDR.dn3_ext import BENDR, ConvEncoderBENDR
...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self):
        ...
        encoder.load("/userhome2/zhoutianyi/BrainDecoding/MindCine/Train/Semantic/LLM/Modules/BENDR/encoder.pt")
        for p in encoder.parameters():
            p.requires_grad = False
        self.model = encoder
        self.scale_param    = torch.nn.Parameter(torch.tensor(1.))
        
        self.downsample     = torch.nn.Conv1d(62, 19, 3, stride=1)
...
eegdata = np.load('data/SEED-DV/Segmented_Rawf_200Hz_2s/sub12.npy')
...
max_lr = 1e-5
current_time ='05-12_22-26'
path='checkpoints/BENDR/05-12_22-26/best_model_40_classes-sub12.ckpt'
...
outdir = f'data/text_embeds/BENDR/{current_time}'
os.makedirs(outdir, exist_ok=True)
torch.save(test_embed, f'{outdir}/block7_40classes_1e-5-sub12.pt')