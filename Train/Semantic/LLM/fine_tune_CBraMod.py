...
checkpoint_callback = ModelCheckpoint(
    dirpath=f'../checkpoints/CBraMod/{current_time}/',  # 模型保存的文件夹
    filename='best_model_10_classes-sub11',  # 文件名
...
trainer = pl.Trainer(accelerator='cuda',
                        ...
                        callbacks=callbacks,
                        logger=[ 
                                pl_loggers.CSVLogger('../logs/', name="CBraMode_csv",version=f'{current_time}')],
