...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self):
        ...
        checkpoint = torch.load("Modules/CBraMod/pretrained_weights.pth",map_location='cpu',weights_only=False)
        model = CBraMod()
...
eegdata = np.load('data/SEED-DV/Segmented_Rawf_200Hz_2s/sub11.npy')
...
max_lr = 1e-5
current_time ='05-12_18-51'
path='checkpoints/CBraMod/05-12_18-51/best_model_40_classes-sub11.ckpt'
...
outdir = f'../text_embeds/CBraMod/{current_time}'
os.makedirs(outdir, exist_ok=True)
torch.save(test_embed, f'{outdir}/block7_40classes_1e-5-sub11.pt')