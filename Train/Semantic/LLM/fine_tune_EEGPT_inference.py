...
import torch
from loss import ClipLoss,GroupLoss
import torch.nn.functional as F
...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self, load_path="/EEGPT/checkpoint/eegpt_mcae_58chs_4s_large4E.ckpt"):
        super().__init__()    
        self.chans_num = 62
        # init model
...
max_lr = 1e-5
current_time ='05-12_11-04'
path='checkpoints/EEGPT/05-12_11-04/best_model_40classes_1e-5-sub3.ckpt'
...
outdir = f'../text_embeds/EEGPT/{current_time}'
os.makedirs(outdir, exist_ok=True)
torch.save(test_embed, f'{outdir}/block7_40classes_1e-5-sub3.pt')