...
max_lr = 1e-5
current_time ='05-13_10-33'
path='checkpoints/Labram/05-13_10-33/best_model_40_classes-sub1-5e-6.ckpt'
...
outdir = f'../text_embeds/Labram/{current_time}'
os.makedirs(outdir, exist_ok=True)
torch.save(test_embed, f'{outdir}/block7_40classes_5e-6-sub1.pt')