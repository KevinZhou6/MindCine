...
@torch.no_grad()
def ddim_loop(unet, ddim_scheduler, latent, num_inv_steps, prompt):
...
@torch.no_grad()
def ddim_inversion(unet, ddim_scheduler, video_latent, num_inv_steps, prompt=""):
    ddim_latents = ddim_loop(unet, ddim_scheduler, video_latent, num_inv_steps, prompt)
    return ddim_latents
